...
const AP_Param::GroupInfo AP_InertialSensor::var_info[] = {
    ...
    // AP_GROUPINFO("AX_EFF", 58, AP_InertialSensor, AXIS_EFFECT, 0),
    ...
    // @User: Advanced
    // @Units: cm/s/s
    AP_GROUPINFO("ACC_F", 58, AP_InertialSensor, ACC_ATK_VAL[0], 0),
    ...
    // @User: Advanced
    // @Units: c-rad/s
    AP_GROUPINFO("GYR_R", 59, AP_InertialSensor, GYR_ATK_VAL[0], 0),
    ...
    // @User: Advanced
    // @Units: cm/s/s
    AP_GROUPINFO("ACC_R", 60, AP_InertialSensor, ACC_ATK_VAL[1], 0),
    ...
    // @User: Advanced
    // @Units: c-rad/s
    AP_GROUPINFO("GYR_P", 61, AP_InertialSensor, GYR_ATK_VAL[1], 0),
    ...
    // @User: Advanced
    // @Units: cm/s/s
    AP_GROUPINFO("ACC_D", 62, AP_InertialSensor, ACC_ATK_VAL[2], 0),
