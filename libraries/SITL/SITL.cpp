...
const AP_Param::GroupInfo SIM::var_gps[] = {
    ...
    AP_GROUPINFO("PDLK_GPS", 50, SIM, pdlk_gps_noise, 2.5), //meters, NEO-M8N
    AP_GROUPINFO("PDLK_GPS_SPD", 51, SIM, pdlk_gps_spd, 50), //mm/s, NEO-M8N
    AP_GROUPINFO("PDLK_ACC", 52, SIM, pdlk_acc_noise, 0.02943), //m/s/s, LSM303D
    AP_GROUPINFO("PDLK_GYRO", 53, SIM, pdlk_gyro_noise, 0.00384 ), //rad/s, L3GD20H
    AP_GROUPEND
};
