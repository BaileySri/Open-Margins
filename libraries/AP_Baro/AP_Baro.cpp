...
const AP_Param::GroupInfo AP_Baro::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("_PDLK_ATK", 25, AP_Baro, PDLK_ATK, 0),
    ...
    // @User: Advanced
    AP_GROUPINFO("_PDLK_TMP", 26, AP_Baro, PDLK_TEMP, 0),
    ...
    // @Increment: MIN_FLOAT MAX_FLOAT
    // @User: Advanced
    AP_GROUPINFO("_PDLK_PRES", 27, AP_Baro, PDLK_PRES, 0),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("_PDLK_CHAN", 28, AP_Baro, CHANNEL, 0),
