...
public:
    AP_OpticalFlow::OpticalFlow_state XXXXState;
...
protected:
    ...
    //XXXX
    float get_flow_x(void) const { return frontend._XXXX_attack_x;}
    float get_flow_y(void) const { return frontend._XXXX_attack_y;}
